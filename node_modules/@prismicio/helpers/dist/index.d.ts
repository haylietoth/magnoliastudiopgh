 ...
 * @see Imgix URL parameters reference: https://docs.imgix.com/apis/rendering
 */
declare const asImageWidthSrcSet: <Field extends _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage | null | undefined>(field: Field, params?: Omit<BuildWidthSrcSetParams, "widths"> & Partial<Pick<BuildWidthSrcSetParams, "widths">>) => AsImageWidthSrcSetReturnType<Field>;
 ...
 * @see Imgix URL parameters reference: https://docs.imgix.com/apis/rendering
 */
declare const asImagePixelDensitySrcSet: <Field extends _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage | null | undefined>(field: Field, params?: Omit<BuildPixelDensitySrcSetParams, "pixelDensities"> & Partial<Pick<BuildPixelDensitySrcSetParams, "pixelDensities">>) => AsImagePixelDensitySrcSetReturnType<Field>;
